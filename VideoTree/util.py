...
def parse_args():
    ...
    parser.add_argument("--data_path", default=os.getenv("CAPTIONS_FILE") , type=str) 
    parser.add_argument("--anno_path", default=os.getenv("QUESTION_FILE_PATH") , type=str)
    parser.add_argument("--duration_path", default=os.getenv("DURATION_FILE_PATH"), type=str) 

    # parser.add_argument("--data_path", default="/root/nas_Ego4D/egoschema/llovi_data/egoschema/lavila_subset.json", type=str) 
    # parser.add_argument("--anno_path", default="/root/nas_Ego4D/egoschema/llovi_data/egoschema/subset_anno.json", type=str)
    # parser.add_argument("--duration_path", default="/root/nas_Ego4D/egoschema/llovi_data/egoschema/duration.json", type=str) 
    ...
    parser.add_argument("--api_key", default=os.getenv("OPENAI_API_KEY"), type=str)
    parser.add_argument("--temperature", default=0.0, type=float)
    parser.add_argument("--prompt_type", default="cap_score", type=str)
