#!/usr/bin/env python3
"""
Final Memory-Optimized SFT Training for 3B Model
"""
...
def main():
    parser = argparse.ArgumentParser(description="Final Memory-Optimized SFT Training")
    parser.add_argument("--model_name", default="Qwen/Qwen2.5-3B")
    parser.add_argument("--trajectory_glob", default="data/raw/*.traj.json")
    parser.add_argument("--out_dir", default="models/sft_3b_final")
    ...
    # Final memory-optimized training arguments (removed invalid parameter)
    ...
    # Train
    print("Starting final memory-optimized SFT training...")
