#!/usr/bin/env python3
"""
Fixed Memory-Optimized SFT Training for 3B Model
"""
...
def main():
    parser = argparse.ArgumentParser(description="Fixed Memory-Optimized SFT Training")
    parser.add_argument("--model_name", default="Qwen/Qwen2.5-3B")
    parser.add_argument("--trajectory_glob", default="data/raw/*.traj.json")
    parser.add_argument("--out_dir", default="models/sft_3b_fixed")
    ...
    # Load model with maximum memory optimizations (removed torch_compile)
    ...
    # Train
    print("Starting memory-optimized SFT training...")
