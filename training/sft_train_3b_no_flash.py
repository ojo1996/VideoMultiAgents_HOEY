#!/usr/bin/env python3
"""
SFT Training for 3B Model without Flash Attention
"""
...
def main():
    parser = argparse.ArgumentParser(description="SFT Training without Flash Attention")
    parser.add_argument("--model_name", default="Qwen/Qwen2.5-3B")
    parser.add_argument("--trajectory_glob", default="data/raw/*.traj.json")
    parser.add_argument("--out_dir", default="models/sft_3b_no_flash")
    ...
    model = AutoModelForCausalLM.from_pretrained(
        ...
        # Removed attn_implementation to use default attention
    )
    ...
    # Train
    print("Starting SFT training without flash attention...")
